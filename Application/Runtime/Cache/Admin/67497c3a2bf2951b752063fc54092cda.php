                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="">
                                ...
                                <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">
                                        ...
                                        <td><?php echo (gettime($data["registertime"])); ?></td>
                                        <td><?php echo (gettime($data["lastlogintime"])); ?></td>
                                        ...
                                        <td>
                                            ...
                                            <button type="button" class="btn btn-default btn-xs btn-danger admin-del" user-id='<?php echo ($data["id"]); ?>' message='禁用' name='<?php echo ($data["username"]); ?>' status="<?php echo ($data["status"]); ?>" <?php if($data["status"] == 0): ?>disabled="disabled"<?php endif; ?>>
                                                <i class=" fa fa-ban fa-fw"></i> 禁用
                                            </button>
                                            <button type="button" class="btn btn-default btn-xs btn-success admin-del" user-id='<?php echo ($data["id"]); ?>' message='开启' name='<?php echo ($data["username"]); ?>' status="<?php echo ($data["status"]); ?>" <?php if($data["status"] == 1): ?>disabled="disabled"<?php endif; ?>>
...
<script>
    var jumpUrl = {
        add_url    : "/demo/admin.php?c=Users&a=add",
        edit_url   : "/demo/admin.php?c=Users&a=edit",
        delete_url : "/demo/admin.php?c=Users&a=setStatus",
    };
</script>
