...
<script>
    var jump = {
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header">网站菜单管理</h3>
                </div>
                <div class="col-sm-2">
                    <ol class="breadcrumb">
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="">
                                ...
                                <tbody>
                                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">
                                        ...
                                        <td><?php echo (gettime($list["edittime"])); ?></td>
                                        <td><?php echo (status($list["status"])); ?></td>
                                        <td>
                                            <button type="button" class="btn btn-default btn-xs btn-primary edit-btn" edn="<?php echo ($list["menu_id"]); ?>">
                                                <i class="fa fa-edit fa-fw"></i>
                                            </button>
                                            <button type="button" class="btn btn-default btn-xs btn-danger admin-del" name="<?php echo ($list["name"]); ?>" user-id="<?php echo ($list["menu_id"]); ?>">
...
<script>
    var jumpUrl = {
        ...
        delete_url : '/demo/admin.php?c=Menu&a=setStatus',
