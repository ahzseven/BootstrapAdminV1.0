            ...
            <div class="row">
                    ...
                    <div class="col-sm-2">
                        <ol class="breadcrumb">
                            ...
                            <li><a href="/demo/admin.php?c=Rbac&a=roleList">返回上一页</a></li>
                    ...
                    <div class="col-lg-6">
                        ...
                        <form class="form-horizontal" id="admin-form">
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" name="name" class="form-control" id="inputname" placeholder="请填写角色名称">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputname" class="col-sm-2 control-label">角色描述:</label>
                                <div class="col-sm-5">
                                    <input type="text" name="remark" class="form-control" id="" placeholder="请填写角色描述">
                                </div>
                            </div>
                            <div class="form-group">
...
var jumpUrl = {
    save_url : "/demo/admin.php?c=Rbac&a=addRole",
    jump_url : "/demo/admin.php?c=Rbac&a=roleList",
};
