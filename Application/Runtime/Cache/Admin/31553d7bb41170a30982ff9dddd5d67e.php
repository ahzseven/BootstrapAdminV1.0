...
<script>
    var jump = {
        ...
        <div id="page-wrapper">
			<div class="row">
	                <div class="col-lg-12">
	                    <h3 class="page-header">添加导航菜单</h3>
	                </div>
                    <div class="col-sm-2">
                        <ol class="breadcrumb">
                            <li><a href="/demo/admin.php?c=Index">Home</a></li>
                            <li><a href="/demo/admin.php?c=Menu">返回上一页</a></li>
            		...
            		<div class="col-lg-6">
            			...
            			<form class="form-horizontal" id="admin-form">
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" name="type" class="form-control" id="" value="前台导航/资讯类型"disabled="disabled" style="background: #F5F5F5;font-weight: 700">
                                </div>
                            </div>
                			...
                			<div class="form-group">
                    			...
                    			<div class="col-sm-5">
                        			<input type="text" name="name" class="form-control" id="inputname" placeholder="填写菜单名称">
                    			</div>
                			</div>
                			<div class="form-group">
                    			<label for="inputname" class="col-sm-2 control-label">描述:</label>
                    			<div class="col-sm-5">
                        			<input type="text" name="description" class="form-control" id="" placeholder="填写菜单描述">
                    			</div>
                			</div>

                			<div class="form-group">
                                <div class="col-sm-offset-2 col-sm-3">
                                    <button type="button" class="btn btn-default btn-primary btn-block" id="admin-btn" onclick="">提交</button>
                                </div>
                                <div class="col-xs-2">
